...
const blocks = [
  {
    ...
    bullets: ["Design & permitting", "Premium modules & racking", "Concierge commissioning"],
  },
  {
    id: "commercial",
    ...
    bullets: ["Load profiling & tariffs", "Fleet & multi-site rollouts", "Ongoing performance ops"],
  },
  {
    id: "farming",
    title: "Solar Farming",
    ...
    bullets: ["Interconnection strategy", "EPC coordination", "Lifecycle analytics"],
  },
];
...
export default function ServicesPage() {
  return (
    <main className="flex flex-1 flex-col bg-zinc-50 text-zinc-900 dark:bg-vigel-dark dark:text-zinc-100">
      <section className="border-b border-zinc-200/80 bg-white/60 px-4 py-28 backdrop-blur-xl dark:border-white/10 dark:bg-white/[0.03] sm:px-6 lg:px-8">
