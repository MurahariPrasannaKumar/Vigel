    ...
    <section className="relative py-24 bg-white sm:py-32">
      <div className="mx-auto max-w-5xl px-6 lg:px-8">
        <motion.div
          ...
          className="group relative isolate overflow-hidden rounded-[2rem] border border-white/10 bg-[#050505] p-6 text-center shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)] sm:rounded-[3rem] sm:p-20"
        >
          {/* --- 1. Background Layer --- */}
          ...
          <div className="relative z-10">
            ...
            <h2 className="mx-auto max-w-2xl font-[family-name:var(--font-syne)] text-3xl font-medium tracking-tight text-white sm:text-5xl lg:text-6xl leading-[1.1]">
            ...
            <div className="mt-12 flex flex-col items-center justify-center gap-6 sm:flex-row">
              <Link
                href="/contact"
                className="group relative inline-flex items-center gap-3 overflow-hidden rounded-full bg-white px-7 py-4 text-xs font-bold uppercase tracking-widest text-black transition-all hover:bg-emerald-500 hover:text-white sm:px-10 sm:text-sm"
              >
                Connect with VIGEL
